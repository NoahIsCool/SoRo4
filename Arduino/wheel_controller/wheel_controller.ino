...
void setup(){
  ...
  wheel[0].write(STOP_PWM);
  wheel[1].write(STOP_PWM);
  wheel[2].write(STOP_PWM);
  wheel[3].write(STOP_PWM);
  wheel[4].write(STOP_PWM);
  wheel[5].write(STOP_PWM);
  gimbal_pan.write(STOP_PWM);
  gimbal_tilt.write(STOP_PWM);
  disk.write(STOP_PWM);
