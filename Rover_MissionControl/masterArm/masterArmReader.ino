...
int joints[3] = {0,1,2}; //shoulder, Elbow, Wrist Pitch (the analog ports the potentiometers are connected to)
...
void sendData(){
  ...
  int data[10] = {-127, ID, (int)analogRead(joints[0])*0.263671875,(int)analogRead(joints[1])*0.263671875,(int)analogRead(joints[2])*0.263671875,0,0,0,0 };
