...
QT_MOC_LITERAL(4, 28, 16), // "errorEncountered"
QT_MOC_LITERAL(5, 45, 12), // "errorMessage"
QT_MOC_LITERAL(6, 58, 11) // "readMessage"

    },
    "comms\0messageReady\0\0message\0"
    "errorEncountered\0errorMessage\0readMessage"
};
...
void comms::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageReady((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->errorEncountered((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (comms::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&comms::messageReady)) {
                *result = 0;
            }
        }
        {
            typedef void (comms::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&comms::errorEncountered)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject comms::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_comms.data,
      qt_meta_data_comms,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *comms::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_comms.stringdata0))
        return static_cast<void*>(const_cast< comms*>(this));
...
// SIGNAL 0
void comms::messageReady(QByteArray _t1)
{
...
// SIGNAL 1
void comms::errorEncountered(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
